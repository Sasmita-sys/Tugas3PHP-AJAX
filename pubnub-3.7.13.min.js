...
(function () {
  ...
  (window.JSON && window.JSON.stringify) ||
    (function () {
      ...
      "function" !== typeof JSON.stringify &&
        (JSON.stringify = function (a, c, e) {
          var g;
          w = f = "";
          if ("number" === typeof e) for (g = 0; g < e; g += 1) w += " ";
          else "string" === typeof e && (w = e);
          if ((q = c) && "function" !== typeof c && ("object" !== typeof c || "number" !== typeof c.length)) throw Error("JSON.stringify");
          return b("", { "": a });
        });
  ...
  function $(a, c) {
    if (a && c)
      if (va(a)) for (var b = 0, e = a.length; b < e; ) c.call(a[b], a[b], b++);
  ...
  function Ia() {
    ...
    function c(a, b) {
      a = "base64" == b.keyEncoding ? CryptoJS.enc.Base64.parse(a) : "hex" == b.keyEncoding ? CryptoJS.enc.Hex.parse(a) : a;
    ...
    var f = "0123456789012345",
      w = ["hex", "utf8", "base64", "binary"],
      E = [128, 256],
      q = ["ecb", "cbc"],
  ...
  if (!window.PUBNUB) {
    var Ja = function (a, c) {
      ...
      Ua = function (a, c, b) {
        $(a.split(","), function (a) {
          ...
          c.addEventListener ? c.addEventListener(a, f, A) : c.attachEvent ? c.attachEvent("on" + a, f) : (c["on" + a] = f);
        });
      },
      Va = function () {
        return Ta("head")[0];
      ...
      db = function (a) {
        ...
        if (Za || $a()) {
          a: {
            ...
            try {
              b = $a() || (window.XDomainRequest && new XDomainRequest()) || new XMLHttpRequest();
    ...
    var vb = {
      ...
      zb = function (a) {
        ...
        function u() {
          clearTimeout(Ba);
          !P || 500 <= P || 1 > P || (!ya(H, r).length && !za(S, r).length)
            ? (Pa = A)
            : ((Pa = r),
              x.presence_heartbeat({
                callback: function () {
                  Ba = setTimeout(u, P * F);
                },
                error: function (a) {
        ...
        function Ga(a, b, c) {
          ...
          if ("number" === typeof a) d = 5 < a || 0 == a ? A : r;
          else {
        ...
        var Ka = +a.windowing || 10,
          xb = (+a.timeout || 310) * F,
          ab = (+a.keepalive || 60) * F,
          yb = a.timecheck || 0,
          bb = a.noleave || 0,
          Q = a.publish_key || "demo",
          t = a.subscribe_key || "demo",
          D = a.auth_key || "",
          Da = a.secret_key || "",
          ib = a.hmac_SHA256,
          sa = a.ssl ? "s" : "",
          ka = "http" + sa + "://" + (a.origin || "pubsub.pubnub.com"),
          O = na(ka),
          jb = na(ka),
          V = [],
          Qa = r,
          ...
          W = {},
          Ba = y,
          T = Ga(a.heartbeat || a.pnexpires || 0, a.error),
          P = a.heartbeat_interval || T / 2 - 1,
          Pa = A,
          Bb = a.no_wait_for_pending,
          lb = a["compatible_3.5"] || A,
          L = a.xdr,
          hb = a.params || {},
          m = a.error || C(),
          Ab =
          ...
          ha = a.db || { get: C(), set: C() },
          ja = a.cipher_key,
          I = a.uuid || (!a.unique_uuid && ha && ha.get(t + "uuid")) || "",
          Z = a.instance_id || A,
          U = "",
          X,
          Y;
        ...
        var Ca = a.crypto_obj || {
          ...
          x = {
            ...
            LEAVE_GROUP: function (a, b, c, d, i) {
              var c = { uuid: I, auth: c || D },
                v = na(ka),
                d = d || C(),
                z = i || C(),
            ...
            channel_group: function (a, b) {
              var c = a.channel_group,
                b = b || a.callback,
                d = a.channels || a.channel,
                i = a.cloak,
                v,
                z,
                h = [],
              ...
              "undefined" != typeof i && (e.cloak = i ? "true" : "false");
              E(a, b, h, e);
            },
            ...
            history: function (a, b) {
              ...
              L({
                ...
                data: B(p),
                c: function (a) {
                  if ("object" == typeof a && a.error) i({ message: a.message, payload: a.payload });
                  else {
            ...
            publish: function (a, b) {
              ...
              var b = b || a.callback || c.callback || C(),
                ...
                z = a.error || c.error || C(),
                h = a.post || A,
                e = "store_in_history" in a ? a.store_in_history : r,
                f = M(),
                s = "push";
              a.prepend && (s = "unshift");
            ...
            unsubscribe: function (a, b) {
              ...
              ga = 0;
              e &&
                ((e = wa((e.join ? e.join(",") : "" + e).split(","), function (a) {
                  if (H[a]) return a + "," + a + ea;
                }).join(",")),
                $(e.split(","), function (a) {
                  var c = r;
              ...
              d &&
                ((d = wa((d.join ? d.join(",") : "" + d).split(","), function (a) {
            ...
            subscribe: function (a, b) {
              ...
              function d() {
                ...
                if (b || j) {
                  ...
                  Aa = L({
                    ...
                    data: B(i),
                    url: [jb, "subscribe", t, encodeURIComponent(b), a, ga],
                    c: function (a) {
                      ...
                      if (Sa && !Ea) (ga = 0), (Sa = A), ha.set(t, 0);
                        ...
                        $(a[0], function (c) {
                          var j = b(),
                            c = G(c, H[j[1]] ? H[j[1]].cipher_key : y);
              ...
              i &&
                $((i.join ? i.join(",") : "" + i).split(","), function (c) {
                  var d = H[c] || {};
                  H[(kb = c)] = { name: c, f: d.f, d: d.d, e: 1, a: (Ra = b), cipher_key: a.cipher_key, i: z, j: g, k: h };
                  R && (W[c] = c in R ? R[c] : R);
                  l &&
                    (x.subscribe({ channel: c + ea, callback: l, restore: Y }),
                    !d.e &&
                      !u &&
                      x.here_now({
                        channel: c,
                        ...
                        callback: function (a) {
                          $("uuids" in a ? a.uuids : [], function (b) {
                            l({ action: "join", uuid: b, timestamp: Math.floor(K() / 1e3), occupancy: a.occupancy || 1 }, a, c);
                          });
                        },
                      }));
                });
              v &&
                $((v.join ? v.join(",") : "" + v).split(","), function (c) {
                  var d = S[c] || {};
                  S[c] = { name: c, f: d.f, d: d.d, e: 1, a: (Ra = b), cipher_key: a.cipher_key, i: z, j: g, k: h };
                  l &&
                    (x.subscribe({ channel_group: c + ea, callback: l, restore: Y, auth_key: D }),
                    !d.e &&
                      !u &&
                      x.here_now({
                        channel_group: c,
    ...
    var Cb = wb || {};
    PUBNUB = zb({ notest: 1, publish_key: Wa(Cb, "pub-key"), subscribe_key: Wa(Cb, "sub-key"), ssl: !document.location.href.indexOf("https") || "on" == Wa(Cb, "ssl"), origin: Wa(Cb, "origin"), uuid: Wa(Cb, "uuid") });
    window.jQuery && (window.jQuery.PUBNUB = zb);
    "undefined" !== typeof module && (module.exports = PUBNUB) && Ha();
    var gb = Ma("pubnubs") || 0;
    if (wb) {
      Xa(wb, { position: "absolute", top: -F });
      if ("opera" in window || Wa(wb, "flash"))
        wb.innerHTML = "<object id=pubnubs data=https://pubnub.a.ssl.fastly.net/pubnub.swf><param name=movie value=https://pubnub.a.ssl.fastly.net/pubnub.swf><param name=allowscriptaccess value=always></object>";
  ...
  var Db = (PUBNUB.ws = function (a, c) {
    ...
    if (!a) return (b.readyState = b.CLOSED), b.onclose({ code: b.CLOSE_ABNORMAL, reason: "Missing URL", wasClean: r }), b;
    b.g = PUBNUB.init(e);
    b.g.n = e;
    b.n = e;
    b.g.subscribe({
